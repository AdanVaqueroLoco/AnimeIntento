        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <form action="{{route('animes.update', $animes->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Editar Anime</h6>
                            <form>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Nombre</label>
                                    <div class="col-sm-10">
                                        <input value="{{$animes->nombre}}" name="nombre" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Genero</label>
                                    <div class="col-sm-3">
                                        <input value="{{$animes->genero}}" name="genero" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input value="{{$animes->descripcion}}" name="descripcion" type="text" class="form-control">
                                    </div>
                                </div>
